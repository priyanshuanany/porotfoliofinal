    ...
    <Container id="sobre">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.2 * 1000}>
          <p>My name is Priyanshu Anany, I am an enthusiastic full Stack Web developer, who recently graduated from Computer Science Engineering. I am proficient in HTML, CSS, JavaScript, React, MongoDb, Express and NodeJs.</p>
        </ScrollAnimation>
